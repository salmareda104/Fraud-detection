...
transformer = pkl.load(open('C://Users//hp//Documents//GitHub//st.FD//transformer.pkl', 'rb'))

# Apply the transformer on the inputs
X_new = transformer.transform(df_new)

# Load the model
loaded_model = pkl.load(open('C://Users//hp//Documents//GitHub//st.FD//final_project.pkl', 'rb'))
